...
namespace BITCollege_BC.Controllers
{
    public class ProgramsController : Controller
    {
        private BITCollege_BCContext db = new BITCollege_BCContext();
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            //Clears the relationship between the program object to be delted and the corresponding Student and Course records such that no cascade happens
